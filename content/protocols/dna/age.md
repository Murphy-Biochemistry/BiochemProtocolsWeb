...
- [Imaging following agarose gel electrophoresis (AGE)]({{< relref "protocols/dna/imaging_age.md" >}})
- [Purification of DNA from agarose gel electrophoresis (AGE)]({{< relref "protocols/dna/purification_age.md" >}})
{{< /tab >}}
