...
1. {{< checkbox >}} [Transform a suitable strain of bacteria and plate transformed bacteria on a LB-agar Plate containing appropriate selection markers (Antibiotic, X-Gal).]({{< relref "protocols/bacteria/transformation.md" >}})
...
- [StrepTag Gravity Flow Protein Purification]({{< relref "/protocols/proteins/streptag_protein_purification" >}})
