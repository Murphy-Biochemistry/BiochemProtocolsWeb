...
| :-- | :-- | :-- | :-- |
| <input type="checkbox"> | <span id="alt_inouetransformationbufferstock10x_r_ms_pipes">PIPES</span>     <span id="alt_inouetransformationbufferstock10x_r_ms_mopes" style="display:none">MOPES</span> | <span id="alt_inouetransformationbufferstock10x_r_vm_pipes">30.0 g</span>     <span id="alt_inouetransformationbufferstock10x_r_vm_mopes" style="display:none">21.0 g</span> | <span id="alt_inouetransformationbufferstock10x_r_mol_pipes">100 mM (1x 10 mM)</span>     <span id="alt_inouetransformationbufferstock10x_r_mol_mopes" style="display:none">100 mM (1x 10 mM)</span> |
| <input type="checkbox"> | MnCl<sub>2</sub> | 108.9 g | 550 mM (1x 55 mM) |
| <input type="checkbox"> | CaCl<sub>2</sub> | 22.0 g | 150 mM (1x 15 mM) |
| <input type="checkbox"> | KCl | 186.5 g | 2.5 M (1x 250 mM) |
