...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url:
        "https://murphy-biochemistry.github.io/BiochemProtocolsWeb/user/registration/success",
      cancel_url:
        "https://murphy-biochemistry.github.io/BiochemProtocolsWeb/user/registration/pricing",
    });
